...
const server = computed(() => site.value ? getServerById(site.value.server_id).value : null)
    ...
    <main class="content" v-else>
      <div class="card">
        ...
        <div v-else class="empty-state">
          <p>Site not found.</p>
          <button class="back-btn" @click="goBack" style="margin-top: 16px;">Go back to sites</button>
        </div>
      </div>
    </main>
  </div>
